...
# Location select box
ubicacion = bform.selectbox("Ubicación", ["Valencia, Estado Carabobo, Venezuela","Maracay, Venezuela","Caracas, Venezuela",
...
if 'provs' in st.session_state:
    ...
    if numeros and nombres:
        st.download_button(label="**Descargar números WhatsApp**", data=func.create_csv(numeros, nombres), file_name='numeros_proveedores_WhatsApp.csv', mime='text/csv')
        st.download_button(label="**Descargar números Fijos**", data=func.create_csv_10(numeros, nombres), file_name='numeros_proveedores_Fijos.csv', mime='text/csv')
